...
requirements = python3, shutil, time, mimetypes, zipfile, stat, kivy==2.3.1, https://github.com/kivymd/KivyMD/archive/master.zip, exceptiongroup, asynckivy, asyncgui, materialyoucolor, android
